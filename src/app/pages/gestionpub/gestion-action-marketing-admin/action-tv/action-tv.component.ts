...
@Component({
  selector: 'ngx-action-tv',
  templateUrl: './action-tv.component.html',
  styleUrls: ['./action-tv.component.scss']
})
export class ActionTvComponent implements OnInit {
  ...
  getCanal(){
    this._canalDiffusionService.findCanalByLibelle("TV").subscribe(response=>{
