...
@Component({
  selector: 'ngx-action-mobile',
  templateUrl: './action-mobile.component.html',
  styleUrls: ['./action-mobile.component.scss']
})
export class ActionMobileComponent implements OnInit {
  ...
  getCanal(){
    this._canalDiffusionService.findCanalByLibelle("Mobile").subscribe(response=>{
